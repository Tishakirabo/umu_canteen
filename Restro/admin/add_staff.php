          ...
          <div class="card shadow">
            ...
            <div class="card-body">
              <form method="POST">
                ...
                <div class="form-row">
                  <div class="col-md-6">
                    <input type="submit" name="addStaff" value="Proceed to Add" class="btn btn-success" value="">
                  </div>
                </div>
              </form>
            </div>

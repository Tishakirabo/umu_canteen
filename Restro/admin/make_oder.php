...
<body>
  ...
  <div class="main-content">
    ...
    ?>
    <!-- Header -->
    <div style="background-image: url(assets/img/theme/repos.png); background-size: cover;" class="header  pb-8 pt-5 pt-md-8">
          ...
          <div class="card shadow">
            ...
            <div class="card-body">
              <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                  <div class="col-md-6">
                    <input type="submit" name="make" value="Proceed" class="btn btn-success" value="">
                  </div>
                </div>
              </form>
            </div>

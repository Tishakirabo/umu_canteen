...
<body>
  ...
  <div class="main-content">
    ...
    ?>
    <!-- Header -->
    <div style="background-image: url(../admin/assets/img/theme/repos.png); background-size: cover;" class="header  pb-8 pt-5 pt-md-8">
            ...
            <div class="card-body">
              <form method="POST" enctype="multipart/form-data">
                ...
                ?>
                  <div class="form-row">
                    <div class="col-md-6">
                      <label>Product Price (Ugx)</label>
                      <input type="text" readonly name="prod_price" value="Ugx <?php echo $prod->prod_price; ?>" class="form-control">
                    </div>
                    <div class="col-md-6">
                ...
                <div class="form-row">
                  <div class="col-md-6">
                    <input type="submit" name="make" value="Add record" class="btn btn-success" value="">
                  </div>
                </div>

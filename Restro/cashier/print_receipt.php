                ...
                <div id="Receipt" class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                    <div class="row">
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <address>
                            <address>
                                <strong>UMU C M S</strong>
                                <br>
                                Your Number 1 Choice Canteen
                                <br>
                                Near Parking Slot, Nkozi Campus
                                <br>
                                (+256) 775-262-383
                            </address>
                        </div>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="col-md-1 text-center">Ugx<?php echo $order->prod_price; ?></td>
                                    <td class="col-md-1 text-center">Ugx<?php echo $total; ?></td>
                                </tr>
                                <tr>
                                    <td>   </td>
                                    <td>   </td>
                                    ...
                                    <td class="text-center">
                                        <p>
                                            <strong>Ugx<?php echo $total; ?></strong>
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="text-center text-danger">
                                        <h4><strong>Ugx<?php echo $total; ?></strong></h4>
                                    </td>
                                </tr>
                            </tbody>
                        </table>

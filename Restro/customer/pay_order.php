            ...
            <div class="card-body">
              <form method="POST"  enctype="multipart/form-data">
                <div class="form-row">
                  ...
                  <div class="col-md-6">
                    <label>Payment Code</label><small class="text-danger"> Type the 10 Digits code you see in this field</small>
                ...
                <div class="form-row">
                  ...
                  <div class="col-md-6">
                    ...
                    <select class="form-control" name="pay_method">
                        <option selected>Send Money to +256775 262383</option>
                    </select>
                  </div>
                </div>
                <br>
